...
FIELDS_FOR_EXPORT = [('name', '患者姓名'),
 ...
 ('eeg_interictal_state', '状态（多选）'),
 ('eeg_interictal_location', '部位（多选）'),
 ('eeg_interictal_morph', '波幅/波形（多选）'),
 ('eeg_interictal_amount', '数量（多选）'),
 ('eeg_interictal_pattern', '出现方式（多选）'),
 ('eeg_interictal_eye_relation', '眼状态相关（多选）'),
