...
urlpatterns = [
    ...
    path("patients/<int:pk>/generate-report/", views.patient_generate_report_stream, name="patient_generate_report_stream"),
    path("patients/<int:pk>/generate-report-rag/", views.patient_generate_report_stream_rag, name="patient_generate_report_stream_rag"),
    path("patients/<int:pk>/generate-report-agent/", views.patient_generate_report_stream_agent, name="patient_generate_report_stream_agent"),
    path("reports/render-markdown/", views.report_render_markdown, name="report_render_markdown"),
    path("reports/export/<str:fmt>/", views.report_export, name="report_export"),
    ...
    path("settings/ollama/create/", views.ollama_server_create, name="ollama_server_create"),
    path("settings/ollama/<int:pk>/edit/", views.ollama_server_edit, name="ollama_server_edit"),
    path("settings/ollama/<int:pk>/delete/", views.ollama_server_delete, name="ollama_server_delete"),
    path("settings/ollama/<int:pk>/enable/", views.ollama_server_enable, name="ollama_server_enable"),
    path("settings/ollama/<int:pk>/test/", views.ollama_server_test, name="ollama_server_test"),
