'''
Django settings for epilepsy_portal project.
...
# LOGOUT_REDIRECT_URL = '/'
LOGIN_URL = "login"
LOGIN_REDIRECT_URL = "epilepsy:dashboard"
...
ROOT_URLCONF = 'epilepsy_portal.urls'
...
WSGI_APPLICATION = 'epilepsy_portal.wsgi.application'
...
LOGGING = {
    ...
    'loggers': {
        ...
        'epilepsy_portal': {'handlers': ['stream'], 'level': 'DEBUG'},
    },
}
